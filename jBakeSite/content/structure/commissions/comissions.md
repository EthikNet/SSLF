...
graph={"query":{"type":"structure", "filter":"code:commune_SSLF", "in":{"category":"personne", "order":"order"}, "groupBy":"related.code"}, "subTemplate":"sslf.comissionsMembresGraphSubTemplate"}
order=959
~~~~~~
Les comissions servent à .....