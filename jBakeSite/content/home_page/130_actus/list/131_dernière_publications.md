...
category=AlaUne
includeContent={"type":"org_openCiLife_post", "category":"publication", "limit":4, "order":"date", "orderDirection":"desc", "showMore":{"label":"voir tout", "to":"${webleger.build.host}/vie_municipale/vieMunicipale.html#actusAndDocuments", "specificClass":"btn btn-primary no_state"}, "display":{"subTemplateItem":"sslf.publicationCompactSubTemplateItem", "type":"publication"}}
tags=
